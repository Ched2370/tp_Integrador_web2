...
function cargarTarjetas(element) {
  ...
  cont_pre_btn.className =
    "card-footer position-absolute bottom-0 start-50 translate-middle-x w-75 h-25 mb-1";

  const precio = document.createElement("p");
  precio.className = "text-bg-dark p-3 fs-6 rounded";
  precio.innerHTML = `<b>Categoria:<b> ${element.category}<br> 
                        <b>Precio:<b> ${element.price}$<br>
...
btnAgregar.addEventListener("click", function () {
    // Inicio de clausulas
    let contador = 1;
    let precioAcumulado = element.price;

    // Función para sumar el precio
    function sumarPrecio() {
        precioAcumulado = element.price * contador;
    ...
    if (divCarrito) {
        ...
        nuevaTarjeta.classList.add("container-fluid", "d-flex", "justify-content-center", "row", "producto");
            ...
            <div class="card p-3 m-3" style="width: 16rem; height: 24rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex rounded px-2 h-10">
                        <p class="fs-6 h-100 py-2 my-auto me-auto precio">$${precioAcumulado.toFixed(2)}</p>
